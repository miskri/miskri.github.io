...
switchOffAllParams = function () {
    ...
    switchOffMovieParams(); // TODO switchOffTvParams

    tvMessage.style.display = "none";
};

switchOffMovieParams = function () {
...
resetMovieParamValues = function () {
    movieFilterParams = {
        category: "movie",
        sortBy: "",
        sortByType: "",
...
toggleOffParams = function (object) {
...
searchMainParam.addEventListener("click", function (event) {
    ...
    if (target.closest("#movieFilter")) {
        ...
        movieParamBlock.style.display = "inherit"; // TODO switchOffTvParams
